...
@WebServlet(urlPatterns = "/DrillDown.ca")
...
protected void doPost(HttpServletRequest request, HttpServletResponse response)
	 ...
	 List <EducationSystemFact> educationList= welcomeservice.rollDown(town);
	 for(int i =0;i<educationList.size();i++) {
		...
		request.getRequestDispatcher("/WEB-INF/views/DrillDown.jsp").forward(request, response);
