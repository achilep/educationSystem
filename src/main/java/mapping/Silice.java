...
@WebServlet(urlPatterns = "/Silice.ca")
public class Silice extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		 ...
		 List <EducationSystemFact> educationList= welcomeservice.silice(lectureName);
		 for(int i =0;i<educationList.size();i++) {
			...
			request.getRequestDispatcher("/WEB-INF/views/Silice.jsp").forward(request, response);
